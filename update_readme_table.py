...
DISPLAY_COLUMNS = ["Dataset Name", "Year", "Related Publication", "EEG headset", "N", "dataset url"]
DISPLAY_HEADERS = ["Dataset", "Year", "Publication", "Headset", "N", "Link"]
        ...
        for col in DISPLAY_COLUMNS:
            ...
            if col == "dataset url" and value:
                if value.startswith("http"):
                    value = f"[Link]({value})"
                # otherwise leave as plain text so it doesn't render as a
                # broken markdown link (e.g. "Mendeley Data - 10.17632/...")
            cells.append(value)
